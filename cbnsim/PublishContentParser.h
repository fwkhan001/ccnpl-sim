...
//
#ifndef CBNSIM_PUBLISHCONTENTPARSER_H
#define CBNSIM_PUBLISHCONTENTPARSER_H
...
namespace cbnsim
{
   ...
   */
  class PublishContentParser : public WorkloadEventParser
    {
    public:
      PublishContentParser()
	: WorkloadEventParser( "publish_content" ) {}
