...
//
#ifndef CBNSIM_SETPREDICATEPARSER_H
#define CBNSIM_SETPREDICATEPARSER_H
...
namespace cbnsim
{
   ...
   */
  class SetPredicateParser : public WorkloadEventParser
    {
    public:
      SetPredicateParser()
	: WorkloadEventParser( "set_predicate" ) {}
