...
namespace cbnsim
{
   ...
   */
  class ReceiverTO : public ssim::Event
  {
  ...
  public:
    ReceiverTO(unsigned int ifid_sent,std::string socket_addr, unsigned int chunk_id, ssim::Time start_time) 
      : m_ifid_sent( ifid_sent ), m_socket_address( socket_addr ), m_chunk_id ( chunk_id ), m_start_time(start_time) {}
