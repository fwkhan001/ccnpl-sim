...
//
// $Id: SRSendTimer.cc,v 1.2 2004/04/19 05:26:39 rutherfo Exp $
//
...
void SRSendTimer :: process_event( const Event* evt )
{
  CBNASSERT( !evt, "SRSendTimer only accepts NULL events" );
  m_node.issue_sr();
  Sim::self_signal_event( NULL, ssbg::rand_poisson_delta( m_delay ) );
}
