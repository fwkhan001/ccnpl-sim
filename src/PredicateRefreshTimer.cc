...
//
// $Id: PredicateRefreshTimer.cc,v 1.2 2004/04/19 05:26:39 rutherfo Exp $
//
...
void PredicateRefreshTimer :: init()
{
...
void PredicateRefreshTimer :: process_event( const Event* evt )
{
  CBNASSERT( !evt, "PredicateRefreshTimer only accepts NULL events" );
  // force the predicate to be issued.
  m_node.issue_predicate( true );
  Sim::self_signal_event( NULL, ssbg::rand_poisson_delta( m_delay ) );
}
